    ...
    <div class="panel panel-default home-panel">
        ...
        <div class="panel-body tab-content">
            <div role="tabpanel" class="tab-pane active" id="latest">
                <h3>Latest</h3>
                <h4>Have a nice day, everyone!<br>
                    P.S. Your face, while you are finished all before sprint deadline :)
                </h4>
                <img src="/image/last.jpg" alt="must be cat" style="width: 200px; height: auto"/>
                <p class="lead"><br>Posted in:</p>
            ...
            <div role="tabpanel" class="tab-pane" id="scheduled">
                <h3>Scheduled</h3>
                <h4>Plan: 01.05.2017 at 00:00
                    <br>Happy Birthday, Mary!</h4><br>
                    <img src="/image/pusheencat.png" alt="must be cat" style="width: 200px; height: auto"/>
                <p class="lead"> Post in:</p>
                    <img src="/image/vkontakte.png" alt="must be cat" style="width: 50px; height: auto"/>
                    <img src="/image/facebook.png" alt="must be cat" style="width: 50px; height: auto"/>
            </div>
        </div>
